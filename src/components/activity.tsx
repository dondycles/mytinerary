...
export default function Activity({
  ...
  return (
    <>
      <div
        key={act.id}
        className={`grid rounded-md ${showActions ? "bg-muted/25 grid-cols-[minmax(0px,116px)_1fr_minmax(0px,36px)] p-2" : "grid-cols-[minmax(0px,124px)_1fr]"} bg-muted/0 p-0 transition-all duration-300`}
      >
